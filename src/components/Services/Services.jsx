...
// Les informations des types de café
const ServicesData = [
    {
        id:1,
        img:Img2,
        name:"Espresso",
        description:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit, asperiores?",
        aosDelay:"300"
    },
    {
        id:2,
  ...
  return (
    <>
        ...
        <div className='container'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 mg:grid-cols-3
