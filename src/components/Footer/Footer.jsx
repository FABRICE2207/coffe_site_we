...
const Footer = () => {
  return <div style={bgImage} className="text-white">
    <div className="bg-black/40 min-h-[400px]">
      <div className="container grid md:grid-cols-3 pb-20 pt-5">
        {/* company details */}
        <div className='py-8 px-4'>
          <a href="#" className='text-semibold track-widset text-2xl sm:text-3xl font-cursive'> Coffee Cafe</a>
          <p className='pt-4 '>
            {"  "}
          ...
          <div className='py-8 px-4 col-span-2 sm:col-auto'>
            ...
            <div>
              ...
              <div className='space-x-3 mt-6'>
                <a href="#">
                  <FaFacebook className='text-3xl inline-block duration-200' />
                </a>
                <a href="#">
                  <FaLinkedin className='text-3xl inline-block duration-200' />
                </a>
                <a href="#">
                  <FaInstagram className='text-3xl inline-block duration-200' />
                </a>
              </div>
            </div>
          </div>
